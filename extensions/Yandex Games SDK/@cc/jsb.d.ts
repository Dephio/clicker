...
declare namespace jsb {
  ...
  type DeviceMotionValue = [
    ...
    AccelerationXYZ,
    AccelerationXYZ,
    AccelerationIncludingGravityXYZ,
    AccelerationIncludingGravityXYZ,
    AccelerationIncludingGravityXYZ,
    RotationRateAlpha,
    RotationRateBeta,
  ...
  export let onControllerInput: (
    infoList: ControllerInfo[]
  ) => void | undefined;
  ...
  export let onOrientationChanged: (event: {
    orientation: number;
  }) => void | undefined; // TODO: enum orientation type
  ...
  export namespace AudioEngine {
     ...
     */
    export function getOriginalPCMBuffer(
      url: string,
      channelID: number
