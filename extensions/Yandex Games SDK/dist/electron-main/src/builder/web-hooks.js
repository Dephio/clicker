...
exports.unload = exports.throwError = exports.onError = exports.onBeforeBuildAssets = exports.load = void 0;
...
const onBeforeBuildAssets = async function (options, result) {
  const buildTask = result.__task;
  const translationsAssetUUID = "af6fd40f-7956-40de-997a-1f6a873ff430";
  const translationsAsset = await buildTask.cache.getInstance(translationsAssetUUID);
  translationsAsset.json = await _common.ipc.main.request("get-l10n-bundle");
